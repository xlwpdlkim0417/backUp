...
public class BoardController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (com.equals("/list") || com.equals("/")) {
			...
			request.setAttribute("msgList", boardService.getMsgList(pageNo));
//			이거 객체생성 계속 해야되니까 무식한 코드임
			request.setAttribute("pgnList", boardService.getPagination(pageNo));
			view = "list.jsp";
			...
			try {
				boardService.writeMsg(writer, title, content);
				view = "redirect:list";
