...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link" href="../_navi/notice.jsp">Hot</a></li>
	...
	// 전체 글 수 조회
	int totalPosts = dao.selectListNumHot(); // getTotalPosts()는 전체 글 수를 반환하는 메소드
	...
	List<Board> list = dao.selectListHot(pagenow, pageSize);
	%>
