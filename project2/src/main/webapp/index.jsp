	...
	<header>
		<div class="inner">
			...
			<ul class="util">
				...
				<c:choose>
					<c:when test="${loginStatus eq 'true' || loginStatus eq 'admin'}">
						<li><a href="memberLogout.do">Logout</a></li>
					</c:when>
					<c:otherwise>
						<li><a href="memberSignUpForm.do">SignUp</a></li>
	...
	<section>
		<div class="inner">
			...
			<div class="wrap">
				<article>
					<div class="pic">
						<img src="img/gom1.jpg" alt="1번째 콘텐츠 이미지">
					</div>
					<h2>
						<a href="#">곰이 물구나무를 서면?</a>
					</h2>
					<p>문</p>
				</article>
				...
				<article>
					<div class="pic">
						<img src="img/gom2.jpg" alt="2번째 콘텐츠 이미지">
					</div>
					<h2>
						<a href="#">곰이 구르면?</a>
					</h2>
